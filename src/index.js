...
export function index(){
    ...
    $('body').append(`<div id="topBar" class="topBar">
        ...
        <span class="right has-text-warning"><a href="https://github.com/TMVictor/Evolve-Scripting-Edition/blob/master/README.md" target="_blank">Why scripting edition ne?</a></span>
    </div>`);
